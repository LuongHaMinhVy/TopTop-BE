...
public class CommentController {
    ...
    public ResponseEntity<ApiResponse<List<CommentResponseDTO>>> getComments(@PathVariable Long videoId) {
        List<CommentResponseDTO> data = commentService.getCommentsByVideo(videoId);
